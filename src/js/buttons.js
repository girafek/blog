function changeContenttl() {
    ...
    setTimeout(() => { document.getElementById('tl').innerHTML = "Copy";  document.getElementById('tl').style.cssText = 'background-color: #305CF8;';  }, 1500);
}
...
function changeContentds() {
    ...
    setTimeout(() => { document.getElementById('ds').innerHTML = "Copy";  document.getElementById('ds').style.cssText = 'background-color: #305CF8;';  }, 1500);
}
